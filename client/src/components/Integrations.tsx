  ...
  const integrations = [
    {
      name: "Circle",
      description:
        "USDC integration for global staking and cross-border rewards",
      icon: DollarSign,
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center space-y-6 mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            UrStake integrates with the best protocols in the ecosystem to
            deliver unparalleled DeFi functionality and yield optimization.
          </p>
        </div>
